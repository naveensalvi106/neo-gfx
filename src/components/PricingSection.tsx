...
const ContactCard = ({ children, href, ...props }: { children: React.ReactNode; href: string; target?: string; rel?: string }) => {
  ...
  return (
    <a
      ...
      className="bg-card rounded-2xl border border-border p-6 flex flex-col items-center gap-3 card-3d hover:border-primary/40 hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 group"
